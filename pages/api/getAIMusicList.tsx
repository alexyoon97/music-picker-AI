...
export default async function handler(req, res) {
  ...
  const response = await openai.createCompletion({
    ...
    prompt: `Recommend me 10 songs related to Music Genre and my situation, Music Genre are ${obj.genre} and I am feeling ${obj.mood} while ${obj.situ} .  Describe a song name and artist and description of this song with youtube link. 
